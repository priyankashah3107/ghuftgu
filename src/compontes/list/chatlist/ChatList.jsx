...
'
        onClick={() => setAddMode((prev) => !prev)} />
          ...
          {chats.map((chat) => (
           ...
           <div className="item flex justify-start items-center gap-[20px] pb-2 pl-6 mt-4 border-b-[2px] border-b-[#a8a8a8] cursor-pointer" key={chat.chatId} onClick={()=> handleSelect(chat)}>
